...
export default function Home2() {
    ...
    let getmovies=async()=>{
        let {data}=await axios.get("https://api.themoviedb.org/3/trending/all/week?api_key=01b2e0cac26308c5e7b9b6e7ea2667b2");
  ...
  return (
      ...
      <div className={`${style.header} vh-100 `}>
       ...
       <div className="header-content text-white mt-5">
        ...
        <p className='text-capitalize  '>have fun while watching </p>
       </div>
       </div>
      </div>
